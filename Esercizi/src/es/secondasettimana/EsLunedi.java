 ...
 * 1: Creare una collezione che permetta la memorizzazione di Prodotti(cod,nome).
   ...
   2: Quattro agenti vendono cinque prodotti.
	  ...
	  Ogni agente fornisce tra 0 e 5 tagliandi al giorno.
   ...
   3: Scrivete un programma che legga una sequenza di date non precisata.
      Alla fine il programma deve stampare la data più recente usando i comparatori.
 */
